...
public class SortingUtil {
    ...
    private static void insert(int[] data, int pos, int value) {
        int i = pos - 1;
    ...
    private static void heapify(int[] data, int i, int max) {
        int largest = i;
        int left = 2*i+1;
        int right = 2*i+2;
    ...
    private static void doQuick(int[] data, int left, int right) {
      if (left<right){
    ...
    private static int[] doMerge(int[] copy, int[] data, int start, int end) {
